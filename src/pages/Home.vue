...
<template>
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-6">
                <p>
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nulla ea suscipit laboriosam officiis
                ...
                <RouterLink class="btn btn-danger ms-2" :to="{name:'posts'}">Posts</RouterLink>
            </div>
        </div>
    </div>
</template>
